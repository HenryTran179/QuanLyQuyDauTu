<div class="header">
    ...
    <div class="header-left">
        <a href="{{ route('home') }}" class="logo"> <img src="{{ URL::to('assets/img/logo.jpg') }}" width="40" height="40" alt=""> </a>
    </div>
    <!-- /Logo -->
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow flag-nav">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javascript:void(0);" class="dropdown-item"> <img src="assets/img/flags/vietnam.png" alt="" height="16"> French </a>
                ...
                <a href="javascript:void(0);" class="dropdown-item"> <img src="assets/img/flags/vietnam.png" alt="" height="16"> VietNam </a>
